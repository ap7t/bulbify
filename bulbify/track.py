...
class Track:
    def __init__(self, sp):
        ...
        self.artists = ", ".join([response["item"]["artists"][i]["name"]
        ...
        self.sections = [Section(section)
                         for section in anal_response["sections"]]
...
class Section:
    ...
    def __str__(self):
        return f"Section(start={self.start},duration={self.duration},self.end={self.end}"
